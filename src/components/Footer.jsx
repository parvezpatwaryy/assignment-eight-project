...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-base-300 text-base-content flex flex-col md:flex-row md:justify-between">
      <nav>
      ...
      <nav>
        <h6 className="footer-title opacity-50 uppercase font-bold mb-2">Social</h6>
        <div className="grid grid-flow-col gap-4">
          ...
          <a className="hover:text-error transition-colors cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
