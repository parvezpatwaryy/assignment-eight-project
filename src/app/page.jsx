...
export default function Home() {
  return (
    <>
      ...
      <Marquee pauseOnHover={true} speed={150} className='bg-gray-400 mt-5 hero-content mx-auto text-black'>
              New Arrivals: Luxury Marble | Weekly Feature: Modern Geometric Patterns | Join the Community...
            </Marquee>
